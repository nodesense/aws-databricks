...
glue_db = "new_glue_db"
glue_tbl = "read"
s3_write_path = "s3://gluetestbucket001/write"
...
# datasink4 = glue_context.write_dynamic_frame.from_catalog(frame = dynamic_frame_write, database = "new_glue_db", table_name = "read", transformation_ctx = "datasink4")
